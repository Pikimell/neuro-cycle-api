...
import medicationIntakesRouter from "./medicationIntakes.js";
import medicationSchedulesRouter from "./medicationSchedules.js";
...
router.use("/medication-schedules", medicationSchedulesRouter);
router.use("/medication-intakes", medicationIntakesRouter);
